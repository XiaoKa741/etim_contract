  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <ReferralCard directReferralCount={user?.directReferralCount ?? 0} referrer={referrer ?? undefined} teamTokenBalance={user?.teamTokenBalance ? formatEther(BigInt(user.teamTokenBalance)) : '0'} s2PlusActive={user?.s2PlusActive ?? false} s6Active={user?.s6Active ?? false} address={address} />
